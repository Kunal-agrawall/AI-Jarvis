...
btn.addEventListener("click", () => {
	// Check if the current text content is "Listening..."
	if (content.textContent === "Listening...") {
		// Change the text to "Click here to speak"
		content.textContent = "Click here to speak";
		// Start the speech recognition
		recognition.abort();
	} else {
		// Change the text back to "Listening..." when starting again
...
function takeCommand(message) {
	if (message.includes("hey") || message.includes("hello")) {
		...
		message.includes("who is your master?") ||
